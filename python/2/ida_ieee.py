...
class fpvalue_t(object):
    ...
    def _get_10bytes(self, *args):
        r"""_get_10bytes(self)"""
        return _ida_ieee.fpvalue_t__get_10bytes(self, *args)

    def _set_10bytes(self, *args):
        r"""
